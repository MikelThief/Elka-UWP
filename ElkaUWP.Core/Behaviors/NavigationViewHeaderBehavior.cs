...
namespace ElkaUWP.Core.Behaviors
{
    public class NavigationViewHeaderBehavior : Behavior<WinUI.NavigationView>
    {
        ...
        public static readonly DependencyProperty DefaultHeaderProperty = DependencyProperty.Register("DefaultHeader", propertyType: typeof(object), ownerType: typeof(NavigationViewHeaderBehavior), typeMetadata: new PropertyMetadata(null, (d, e) => _current.UpdateHeader()));
        ...
        public static readonly DependencyProperty HeaderModeProperty =
            DependencyProperty.RegisterAttached("HeaderMode", propertyType: typeof(bool), ownerType: typeof(NavigationViewHeaderBehavior), defaultMetadata: new PropertyMetadata(NavigationViewHeaderMode.Always, (d, e) => _current.UpdateHeader()));
